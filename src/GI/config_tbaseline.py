...
class Config():
    def __init__(self,args):
        ...
        if args.data == "house":
            ...
            from models_GI import ClassifyNetHuge, MLP_house
        ...
        if args.data == 'elec':
            ...
            self.model_kwargs =  {"data_shape":8, "hidden_shape":128, "out_shape":1,  "time2vec":False,"append_time":True,"time_conditioning":False}
            self.lr = 5e-3
            self.classifier_loss_fn = binary_classification_loss
            self.num_finetune_domains = 2
            self.loss_type = 'classification'
