...
class M5house(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return np.concatenate([sample,y.reshape(1)]).astype('f'), int(y*12)-1, target.reshape(1)
...
class M5Sampler(torch.utils.data.sampler.Sampler):
